...
def inquiry(request):
    if request.method == "POST":
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request,'You have aldready made an inquiry about this car. Please wait until we get back to you.')
        ...
        contact.save()
        messages.success(
            request, 'Your request has been submitted, we will get to you shortly.')
        return redirect('/cars/'+car_id)
